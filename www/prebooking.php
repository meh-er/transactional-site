...
<h1><i class="far fa-calendar-alt"></i>Booking Form</h1>
<div class="fields">
<!-- Input Elements -->
<!--	
<div id="Location">
<select name="Booking_location" id="travel_arriveVia" onchange="showfield(this.options[this.selectedIndex].value)">
<option selected="selected">Please select a room</option>
